...
export default function OccasionsPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-pink-50 py-12 px-4 sm:px-6 lg:px-8 animate-fadeIn mt-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredOccasions.map((occasion) => (
              <OccasionCard
                ...
                Icon={occasion.Icon}
                className="transform transition duration-500 hover:scale-105 hover:shadow-2xl animate-float cursor-pointer"
              />
            ))}
          </div>
        </div>
