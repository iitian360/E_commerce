          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.button
                  ...
                  // whileTap={{ scale: 0.95 }}
                  type="submit"
                  className=" sendMsg w-50 bg-gradient-to-r from-pink-500 to-pink-700 text-white py-3 px-6 rounded-xl font-medium hover:from-pink-600 hover:to-pink-800 transition-all duration-300"
                >
                  Send Message
                </motion.button>
              </form>
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <div className="flex gap-2 w-full max-[440px]:flex-wrap">
                  <motion.div
                    // whileHover={{ scale: 1.05 }}
                    className="flex items-center flex-col w-1/2 bg-gray-100 p-4 h-36 cursor-pointer  max-[440px]:w-full"
                  >
                ...
                <div className="flex gap-2 w-full max-[440px]:flex-wrap">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">1234 Example St, City, Country</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    <FaMapMarkerAlt className="text-pink-500 mr-4" />
                    <div>
                      <h3 className="font-semibold text-center">Live on map</h3>
                      <p className="text-gray-600 text-sm">1234 Example St, City, Country</p>
                    </div>
                  </motion.div>
                </div>
