...
const Login = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-pink-200 to-pink-300 py-12 px-4 sm:px-6 lg:px-8 flex flex-col animate-fade-in mt-12">
      {/* <div className="fixed top-0 left-0 w-full z-50"> */}
        {/* <Navbar /> */}
      {/* </div> */}
        ...
        <div className="w-full max-w-md bg-white shadow-md rounded-lg p-8 animate-zoom-in">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                type="text"
                className="w-full px-4 py-2 mt-2 border-none bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500"
                value={emailOrMobile}
            ...
            <button
              type="submit"
              className="w-44 bg-pink-500 text-white py-2 rounded-md hover:bg-pink-600 text-lg filterBtn"
            >
              Login
            </button>
          </form>
