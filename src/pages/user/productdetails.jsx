...
const ProductDetail = () => {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 w-full z-50">
      ...
      <ToastContainer />
      <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white py-12 mt-28">
        <AnimatePresence>
          {showLoginDialog && (
            <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center bg-yellow-50 px-3 py-1 rounded-full shadow-lg">
                    <span className="text-yellow-400 mr-1 text-xl">★</span>
                    <span className="font-medium">{product.rating}</span>
                  </div>
                  <div className="bg-pink-50 px-4 py-2 rounded-full shadow-lg">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center">
                      <button 
                        className="bg-gray-200 hover:bg-gray-300 px-4 py-2 rounded-sm transition"
                      ...
                      <input
                        type="text"
                        value={quantity}
                        className="border-y border-gray-200 text-center w-16 py-2 border-none outline-none"
                        readOnly
                      />
                      <button 
                        className="bg-pink-200 hover:bg-pink-300 px-4 py-2 rounded transition"
                        onClick={() => handleQuantityChange(1)}
                      >
                        +
                      </button>
                  ...
                  {/* Add to Cart Button */}
                  <button 
                    className="w-full bg-pink-500 text-white py-3 rounded-lg transition transform duration-200 font-semibold filterBtn"
                ...
                <div className="pt-6 border-t">
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-pink-500 text-white px-6 py-2 rounded-lg hover:bg-pink-500 filterBtn">
                      Write a Review
                    </button>
                  </div>
                </div>
